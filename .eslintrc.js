{
  ...
  "rules": {
    ...
    #"space-infix-ops": [1, "always"], // require spaces around operators CURRENTLY BREAKING
    ...
    "max-len": [0, 150, 2], // specify the maximum length of a line in your program (off by default)
